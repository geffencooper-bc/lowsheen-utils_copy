...
// ---------------------------------------------------- STU data ------------------------------------------------
    ...
    // ID = 0x009 and 0x00E
    uint8_t CanDataList::eeprom_access_line_write_data[16] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
bool CanDataList::array_compare(uint8_t* expected, uint8_t num_bytes_expected, uint8_t* actual, uint8_t num_bytes_actual)
{
