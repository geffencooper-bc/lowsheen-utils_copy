...
uint8_t SEND_START_ADDRESS[8]        =  {0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0x9A, 0x00, 0x00};
uint8_t SEND_CHECKSUM_DATA[8]        =  {0x03, 0xFF, 0xFF, 0xFF, 0xFF, 0x9B, 0x00, 0x00};
uint8_t SEND_DATA_SIZE[8]            =  {0x04, 0xFF, 0xFF, 0xFF, 0xFF, 0x9C, 0x00, 0x00};
uint8_t SEND_END_OF_FILE[8]          =  {0x05, 0xFF, 0x00, 0x00, 0x00, 0x90, 0x00, 0x00};
uint8_t TOTAL_CHECKSUM_REQUEST[8]    =  {0x06, 0xFF, 0xFF, 0xFF, 0xFF, 0x9D, 0x00, 0x00};
uint8_t SEND_PAGE_CHECKSUM[8]        =  {0x07, 0xFF, 0xFF, 0xFF, 0xFF, 0x9E, 0xFF, 0x00};
